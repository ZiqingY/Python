...
print()
boris = np.array([ [1,2], [9,8], (0.1,0.2) ], dtype=np.int32)
print(boris)
...
# 3.2 new_x=x.astype(new_type) 改变数组类型; 若和原类型一样，则相当于拷贝
print()
...
o=np.sqrt(t)
print(t)
print(np.around(o, decimals=2, out=None))
                      #小数点后面保留两位
